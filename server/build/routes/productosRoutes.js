...
class ProductosRoutes {
    ...
    config() {
        ...
        this.router.get('/:cveProducto', productosController_1.default.getOne);
        this.router.post('/', productosController_1.default.create);
        this.router.put('/:cveProducto', productosController_1.default.update);
        this.router.delete('/:cveProducto', productosController_1.default.delete);
    }
}
